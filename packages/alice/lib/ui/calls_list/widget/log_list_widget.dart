...
import 'package:alice/ui/calls_list/widget/error_logs_widget.dart';
...
class LogListWidget extends StatefulWidget {
  ...
  @override
  State<LogListWidget> createState() => _AliceLogListWidgetState();
}

/// State for logs list widget.
class _AliceLogListWidgetState extends State<LogListWidget> {
...
class _AliceLogEntryWidget extends StatelessWidget {
    ...
    final Text content = Text.rich(
      TextSpan(
        children: [
          ...
          ..._toText(
            context,
            context.i18n(TranslationKey.logsItemStackTrace),
            log.stackTrace,
  ...
  Color _getTextColor(BuildContext context) {
    return AliceAppTheme.getLogTextColor(context, log.level);
  }
