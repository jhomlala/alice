  ...
  static AliceTranslationData _buildEnTranslations() {
    return AliceTranslationData(
      ...
      values: {
        ...
        AliceTranslationKey.actionShare: "Share",
        AliceTranslationKey.actionShareCurl: "Share CURL",
  ...
  static AliceTranslationData _buildPlTranslations() {
    return AliceTranslationData(
      ...
      values: {
        ...
        AliceTranslationKey.saveLogCurl: "Curl",
        AliceTranslationKey.actionShare: "Udostępnij",
        AliceTranslationKey.actionShareCurl: "Udostępnij CURL",
