...
class AliceTranslations {
  ...
  static AliceTranslationData _buildPlTranslations() {
    return AliceTranslationData(languageCode: "pl", values: {
      ...
      AliceTranslationKey.saveDialogEmptyErrorTitle: "Pusta historia połaczeń",
      AliceTranslationKey.saveDialogEmptyErrorDescription:
      ...
      AliceTranslationKey.saveLogRequestContentType: "Typ zawartości żądania:",
      AliceTranslationKey.saveLogRequestCookies: "Ciasteczka żądania:",
      AliceTranslationKey.saveLogRequestHeaders: "Heady żądania",
      AliceTranslationKey.saveLogRequestQueryParams: "Parametry query żądania",
