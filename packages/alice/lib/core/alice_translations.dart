...
class AliceTranslations {
  ...
  static AliceTranslationData _buildEnTranslations() {
    return AliceTranslationData(languageCode: "en", values: {
      ...
      AliceTranslationKey.saveDialogPermissionErrorDescription:"Permission not granted. Couldn't save logs.",
      AliceTranslationKey.saveDialogEmptyErrorTitle:"Call history empty",
      AliceTranslationKey.saveDialogEmptyErrorDescription:"There are no calls to save.",
      AliceTranslationKey.saveDialogFileSaveErrorTitle:"Save error",
      AliceTranslationKey.saveDialogFileSaveErrorDescription:"Failed to save http calls to fil",
      AliceTranslationKey.saveSuccessTitle:"Logs saved",
      AliceTranslationKey.saveSuccessDescription:"Successfully saved logs in [path].",
